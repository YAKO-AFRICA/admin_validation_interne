...
$plus = " AND tblrdv.etat = '" . $etat . "'";

$sqlSelect = "SELECT tblrdv.* ,  concat (users.nom,' ',users.prenom) as nomgestionnaire  FROM tblrdv LEFT JOIN users on tblrdv.gestionnaire = users.id WHERE tblrdv.gestionnaire= '" . trim($_SESSION['id']) . "' $plus ORDER BY idrdv DESC";
