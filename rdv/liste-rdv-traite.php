		...
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
						...
						<div class="col-md-12 col-sm-12">
							...
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page"> Recapitulatif des traitements des prestations </li>
								</ol>
							</nav>
						</div>
					</div>
				...
				<div class="card-box mb-30">
					<div class="pd-20">
						<h4 class="text-left" style="color:#033f1f; "> Liste des traitements des prestations acceptées ( <span style="color:#F9B233;"><?= $effectue ?></span> ) </h4>
					</div>
								...
								?>
										<tr>
											...
											<td>
												...
												<span class="<?php echo $prestations->estMigree == "1" ? "badge badge-success" : "badge badge-secondary"; ?>"><?php echo $prestations->estMigree == "1" ? "Oui" : "En attente"; ?></span>
											</td>
