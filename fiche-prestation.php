...
if (isset($_COOKIE["id"])) {
    ...
    if ($prestation == null) {
        header('Location: liste-prestation');
    } elseif ($prestation[0]->etape != "1") {
        header('Location: detail-prestation');
    }
...
<body>
        ...
        <div class="pd-ltr-20 xs-pd-20-10">
            <div class="min-height-200px">
                ...
                <div class="card-body height-100-p pd-20">
                    <div class="card-box mb-30">
                        <div style="float:left" class="p-2">
                            <button class="btn btn-warning p-2 m-2" onclick="retour()"><i
                                    class='fa fa-arrow-left'>Retour</i></button>
                        </div>
                    </div>
                    <div class="card-body radius-12 w-100 p-4" style="border:1px solid gray;background:#033f1f">
                        <h3 class="text-center" style="color:white">Demande de Prestation n° <span
                                style="color:#F9B233;"><?= strtoupper($code) ?></span></h3>
                    </div>
                </div>
                <hr>
                <div class="row">
                            ...
                            <div class="card-body radius-12 w-100 p-4"
                                ...
                                if ($retour_documents != null) {
                                    ...
                                    for ($i = 0; $i <= count($retour_documents) - 1; $i++) {
                                        ...
                                        $nom_document = $fonction->getNomDocument($type_doc);
                                        $values = $id_prestation . "-" . $ref_doc . "-" . $nom_document . "-" . $doc_name;

                                ?>
                                        <div class="document-card d-flex align-items-center mt-3 p-2 border rounded"
                                            id="line_<?= $ref_doc ?>">
                                            <input type="text" class="val_doc" name="val_doc" value="<?php echo $values; ?>"
                                                hidden>
                                            <input type="text" class="path_doc" name="path_doc"
                                                value="<?php echo $documents; ?>" hidden>
                ...
                ?>
                    <div class="pd-20">
                        <div class="card-box height-100-p pd-20">
                            <h4 class="text-center p-2" style="color:#033f1f;  font-weight:bold; "> traitement de la demande
                                de prestation </h4>
                            <div style="border-top: 4px solid #033f1f;width : 100%;text-align: center;"></div>
                            <div class="row card-body" style="background: #D3D3D3;" id="infos_perso">
                                <div class="col-md-6">
                                    <p style="float:left">Traité le : <span class="text-infos" id="dateheure"
                                            style="font-size:18px; font-weight:bold;"><?= $prestation->created_at; ?></span>
                                    </p>
                                    <span class="text-infos" style="color:#033f1f ; color:white !important"></span>
                                </div>
                                <div class="col-md-6">
                                    <p style="float:right">Traité par : <span class="text-infos"
                                            style="font-size:18px; font-weight:bold;"><?php echo $_SESSION['utilisateur'];  ?></span>
                                    </p>
                                </div>
                                <input type="text" id="id_prestation" name="id_prestation" value="<?= $prestation->id; ?>"
                                    hidden>
                                <input type="text" class="form-control" id="codeprest" name="codeprest"
                                    value="<?php echo $prestation->code; ?>" hidden>

                                <input type="text" id="valideur" name="valideur"
                                    value="<?php echo $_SESSION['utilisateur'];  ?>" hidden>
                            </div>
                            <div class="row">
                                    ...
                                    <div class=" offset-md-6 col-md-6">
                                        <div class="form-group">
                                            <label for="message" class="col-form-label"
                                                style="font-size:18px; font-weight:bold;">Etat de la demande de prestation
                                                :</label>
                                        </div>
                                        <div class="form-group row">
                                            <div class="custom-control custom-radio mb-5 col">
                                                <input type="radio" id="customRadio1" name="customRadio"
                                                    class="custom-control-input" value="3" style="color:red">
                                                <label class="custom-control-label" for="customRadio1"
                                                    style="color:red; font-weight:bold">Rejété la demande</label>
                                            </div>
                                            <div class="custom-control custom-radio mb-5 col">
                                                <input type="radio" id="customRadio2" name="customRadio"
                                                    class="custom-control-input" value="1">
                                                <label class="custom-control-label" for="customRadio2"
                                                    style="color:gray!important; font-weight:bold;">En attente</label>
                                            </div>
                                            <div class="custom-control custom-radio mb-5 col">
                                                <input type="radio" id="customRadio3" name="customRadio"
                                                    class="custom-control-input" value="2">
                                                <label class="custom-control-label" for="customRadio3"
                                                    style="color: #033f1f; font-weight:bold;">Accepter la demande</label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="modal-content">
                <div class="modal-body text-center font-18">
                    <h4 class="padding-top-30 mb-30 weight-500">
                        Voulez vous rejeter la demande de prestation <span id="a_afficher_1"
                            style="color:#033f1f!important; font-weight:bold;"> </span> ?
                        <!--br> Motif de rejet: <span id="a_afficher_2" style="color: #F9B233 !important; font-weight:bold;"> </span-->
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('input[name="customRadio"][value="' + <?php echo $prestation->etape; ?> + '"]').attr(
                'checked', 'checked');
            ...
            $('input[name="customRadio"]').change(function() {
                ...
                if (valeur == '3') {
                    ...
                    if (tablo_documents.length == 0) {
                        ...
                        showToast("Désolé, aucun document joint , veuillez rejeter la prestation.",
                            "warning");
                        ...
                        if (document_valider.length === tablo_attendu.length) {
                            ...
                            showToast(
                                "Désolé, veuillez vérifier que tous les documents joints soient corrects, puis valider la prestation ou cliquer sur rejeter la prestation.",
                                "warning");
                        }
                    }
                    ...
                    showToast("La prestation est en attente", "secondary");
                ...
                success: function(response, status) {
                    ...
                    if (response != '-1' && response != '0') {
                        ...
                        a_afficher = `<div class="alert alert-danger" role="alert">
								<h2>"Désolé , une erreur est survenue sur lors du rejet de la prestation <span class="text-success">` + code +
        ...
        $("#optionTraitement").on("click", "#valider", function(evt) {
            ...
            // Vérifier que la case "certification" est cochée
            const certifie = document.getElementById("certification");
            if (!certifie || !certifie.checked) {
                showToast("Merci de cocher la case de déclaration de conformité avant de valider.", "error");
                return false;
            }*/

            // Ensuite, vérifie les documents comme tu le fais déjà :
            if (document_valider.length == tablo_documents.length) {
                // Code existant pour afficher le spinner et faire l'appel Ajax
                ///...
                ...
                $("#afficheuse").empty();
                $('input[name="customRadio"][value="1"]').prop('checked', true);
                showToast("Désolé, merci de vérifier que tous les documents joints ont bien été validés.",
                    "error");
                return false;
            }
        });
            ...
            if (retour) {
                ...
                $.each(contactsPersonne, function(indxct, contactP) {
                    ...
                    if (contactP.contact != "" && contactP.contact != null) {
                        numero += `
                            Numero ${indxct+1} : </span><span class="text-infos" style="font-size:14px; font-weight:bold;">${contactP.contact}</span><br>
                            `
                    }
                })
                ...
                $.each(details, function(indx, data) {
                    ...
                    let prime = number_format(data.TotalPrime, 0, ',', ' ');
                    let capital = number_format(data.CapitalSouscrit, 0, ',', ' ');
                    let TotalEmission = number_format(data.TotalEmission, 0, ',', ' ');
                    let TotalImpayes = number_format(data.TotalImpayes, 0, ',', ' ');
                    let TotalEncaissement = number_format(data.TotalEncaissement, 0, ',', ' ');
                    ...
                    infos += `
                        ...
                        <div class="row  w-100">
                            ...
                            <div class="form-group  col-md-4" style="font-size:12px; font-weight:bold;"> Capital : </span><span class="text-infos" style="font-size:14px; font-weight:bold;">${capital} FCFA</span></div>
                            <div class="form-group  col-md-4" style="font-size:12px; font-weight:bold;"> Prime  : </span><span class="text-infos" style="font-size:14px; font-weight:bold;">${prime} FCFA</span></div>
                        ...
                        <div class="row  w-100">
                            ...
                            <div class="form-group  col-md-4" style="font-size:12px; font-weight:bold;"> Total Emission  : </span><span class="text-infos" style="font-size:14px; font-weight:bold;">${TotalEmission} FCFA</span></div>
                            ...
                            <div class="form-group  col-md-4" style="font-size:12px; font-weight:bold;"> Total Encaissement  : </span><span class="text-infos" style="font-size:14px; font-weight:bold;">${TotalEncaissement} FCFA</span></div>
                            ...
                            <div class="form-group  col-md-4" style="font-size:12px; font-weight:bold;"> Total Impayes  : </span><span class="text-infos" style="font-size:14px; font-weight:bold;">${TotalImpayes} FCFA</span></div>
                        </div>`
                })
