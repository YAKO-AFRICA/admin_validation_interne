		...
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
				...
				<div class="page-header">
					<div class="row">
						<div class="col-md-12 col-sm-12">
							<div class="title">
								<h4>Liste des Rendez-vous Transmis - Traités</h4>
							</div>
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									<li class="breadcrumb-item"><a href="accueil-operateur.php"><?= Config::lib_pageAccueil ?></a></li>
									<li class="breadcrumb-item active" aria-current="page"> Liste des Rendez-vous Transmis - Traités </li>
								</ol>
							</nav>
						</div>
					</div>
				...
				<div class="card-box mb-30">
					<div class="pd-20">
						<h4 class="text-center" style="color:#033f1f; "> Liste des Rendez-vous Transmis - Traités (<span style="color:#F9B233;"><?= $effectue ?></span>) </h4>
					</div>
								...
								?>
										<tr>
											...
											<td class="table-plus text-wrap">
												...
												<?php if ($rdv->etat == "1") { ?>
													<label class="btn btn-secondary" style="background-color: #033f1f ;" for="click-<?= $i ?>"><i class="fa  fa-mouse-pointer" id="click-<?= $i ?>"> Traiter le rdv </i></label>
												<?php  } ?>
											</td>
