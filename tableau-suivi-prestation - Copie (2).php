                        ...
                        <div id="afficheuseStatAdministrative">
                            ...
                            <div class="bg-white pd-20 card-box mb-30">
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12 mb-3">
                                        <div id="chartTypePrestationAdministratif">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div id="afficheuseStatNONAdministrative">
                            ...
                            <div class="bg-white pd-20 card-box mb-30">
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12 mb-3">
                                        <div id="chartTypePrestationNONAdministratif">
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <script>
        ...
        function afficheuseMotif(tabloMotif, colors) {
            ...
            let htmlMotif = `<div class="card-box pd-20 shadow-sm border rounded">
                                            <h5 class="mb-3">Statistiques par Type de Prestation :</h5>
        ...
        function afficheuseTypePrestationAdministratif(tabloMotif, colors) {
            ...
            let htmlMotif = `<div class="card-box pd-20 shadow-sm border rounded">
                                            <h5 class="mb-3">Statistiques par Type de Prestations Administratives:</h5>
            ...
            if (tablo_graph.length == 0) {
                ...
                Highcharts.chart('chartTypePrestationAdministratif', {
                    colors: tablo_color,
                    title: {
                        text: 'Statistiques par Type Prestations Administratives'
                    },
                    xAxis: {
                        categories: ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec']
                    },
