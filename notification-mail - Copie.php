...
if ($idprestation != null) {
    ...
    if ($retour != null) {
        ...
        $retour_documents = $fonction->_getListeDocumentPrestation(1);
        ...
        if ($retour_documents !== null) {
            for ($i = 0; $i <= count($retour_documents) - 1; $i++) {
                ...
                elseif ($type_doc == "etatPrestation") $nom_document = "Fiche de demande de prestation";
        ...
        switch ($action) {
            ...
            case "confirmerRejet":
                ...
                $titre = "<label style='color:red'> La demande de prestation <b>" . $prestation->code . "</b>  a été rejetée</label>,</br>Motif : <b>" . $prestation->observationtraitement . "</b></br>";
